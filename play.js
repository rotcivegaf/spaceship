...
var play_state = {
    ...
    create_bullets:function(){
        ...
        this.fire_time = 0;
        //this.bullet.animations.add('w', [0,1,2,3], 7, true);
    },
    ...
    add_meteorite: function(x, y, velocity) {
        ...
        meteorite.animations.add('rotar', [0,1,2,3], 10, true);
